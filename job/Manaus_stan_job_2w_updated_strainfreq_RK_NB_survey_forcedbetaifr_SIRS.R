...
inits_list_2w_updated_strainfreq <- readRDS(paste0(job_location,"/input/inits_list_2w_strainfreq_survey_SIRS"))
inits_list_2w_updated_strainfreq

manaus_model_2w_updated_strainfreq <- cmdstan_model(paste0(job_location,"/stan/manaus_2w_updated_s1re_strainfreq_RK_NB_survey_forcedbetaifr_SIRS.stan"))
...
filename_df <- paste0(job_location,"/output/",current_time,"_manaus_2w_updated_s1re_strainfreq_RK_NB_survey_SIRS")
