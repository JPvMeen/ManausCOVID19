...
transformed data {
  ...
  real<lower=0> scalar_beta1_re = 1; // waned immunity reduced susceptiblity against B.1 scalar
  real<lower=0> scalar_beta2_re = 1; // waned immunity reduced susceptiblity against P.1 scalar

  real<lower=0> scalar_ifr1 = 1; // Reinfection fatality scalar B.1
  real<lower=0> scalar_ifr2 = 1; // Reinfection fatality scalar P.1
}
